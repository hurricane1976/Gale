#!/usr/bin/env bash
# Staged remote-pairing batch for BORA: 19 fleet peers in 401 state
# (roster-20260921.md; BEACON + MOUNTAIN removed 2026-09-23 — already
# two-way, verified in ledger/20260923-outbound-verify.md).
#
# Bora's half is ALREADY INSTALLED for all 19 (fleet-provision
