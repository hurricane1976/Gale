#!/usr/bin/env bash
# Runs pair_peer.sh for every roster entry not already paired -- ZEPHYR's
...
# since Zephyr isn't paired with Beacon/Tidal/Mountain at all yet, unlike
...
echo "When they mint their half back to Zephyr, install it here with:"
echo "  cd ~/zephyr && ./install_peer_block.sh <block-file> --service zephyr-peer"
