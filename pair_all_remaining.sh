#!/usr/bin/env bash
# Runs pair_peer.sh for every roster entry not already paired -- CHINOOK's
...
# since Chinook isn't paired with Beacon/Tidal/Mountain at all yet, unlike
...
echo "When they mint their half back to Chinook, install it here with:"
echo "  cd ~/chinook && ./install_peer_block.sh <block-file> --service chinook-peer"
