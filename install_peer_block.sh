...
#
# Examples:
#   # peer operator receives block via out-of-band channel, saves to /tmp/poniente.block (600):
#   ./install_peer_block.sh /tmp/poniente.block
#   rm /tmp/poniente.block  # clear scrollback/history too
#
#   # if your peer service is not <selfname>-peer (auto-detected from SELF_NAME):
#   ./install_peer_block.sh /tmp/poniente.block --service beacon-peer
#
