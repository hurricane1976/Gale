#!/usr/bin/env python3
"""Dynamic Telegram command handler for Vortex.
...
trimmed to Vortex's needs. For each new message *from the operator's exact
chat id*:
  ...
  * anything else -> appended to .telegram_incoming so the next waking's
    ...
    stays visible until Vortex resolves it.
